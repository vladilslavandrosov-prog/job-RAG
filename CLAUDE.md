...
- После любой правки файла, который уже отправлялся пользователю (SendUserFile), автоматически выгружать обновлённую версию заново — не дожидаться отдельной просьбы «выгрузи»/«пришли».
